                    ...
                    <div className='ms-4 mt-4'>
                        {
                            ...
                            && aboutYou ? <AboutYouForm setCompany={setCompany} setPhone={setPhone} setLocation={setLocation} /> : freelaButton 
                            && aboutYou ? <AboutYouFreeForm /> : personButon 
                            && aboutYou ? <AboutYouPersonForm /> : companyButton 
                            && profileData ? <ProfileDataForm /> : <ProfileDataFyPForm />
                        }
                    </div>
                    <div className='mb-3' style={ accountData || aboutYou ? { marginTop: '0rem', paddingTop: '2rem', textAlign: 'center'} : { marginTop: '0rem', paddingTop: '0rem', textAlign: 'center'} } >
                        <NavLink to="/register" type="button"
